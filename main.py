...
@@ -185,95 +183,122 @@ prompt = ChatPromptTemplate.from_messages([
...
def build_lead_signature(lead: Dict) -> str:
    return json.dumps(
        {
...
@@ -338,111 +363,189 @@ def show_admin_dashboard():
...
@@ -467,128 +570,138 @@ with st.sidebar:
